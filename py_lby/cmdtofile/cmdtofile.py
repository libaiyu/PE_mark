...
# Do not copy the command that can not work correctly. 2017-3-2
...
def main():
    DIR = getdir.getdir()
    SRCDOC = DIR + '\\' + input('please input the source file name *.py(*.txt): ')
    DSTDOC = DIR + '\\' + input('please input the destination file name *.py:')
