...
''' make the mark list of the file(“ 高考体育成绩对照表”), from the file
(“高考体育成绩测量表”)to get the information, then look it up in the mark dict
to get the mark. Finally write the mark to a new file.     2017-7-12 '''
